#ifndef PROJECT0_TEXTURE_H
#define PROJECT0_TEXTURE_H
...
public:
    ...
    virtual vec3 value(double u, double v, const vec3& p) const {
        double turb_frequency = 10.0;
        return vec3(1,1,1) * 0.5 * (1 + sin(scale*p.z() + turb_frequency*noise.turb(p)));
    }
